...
# Hyprland
HYPR_ACTIVE_BORDER="rgba(8b94d9ff)"
HYPR_INACTIVE_BORDER="rgba(7380b0ff)"
...
# Discord
DISCORD_BG="https://i.imgur.com/huKNuUD.png"
...
# FastFetch
FASTFETCH_IMAGE="~/.config/fastfetch/images/reze.png"
FASTFETCH_KEYS_COLOR="#7bc3ed"
